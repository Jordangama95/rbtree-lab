# Agent workflow
- Before answering any question or starting any task in this repository, read this entire `CLAUDE.md` file.
- Treat the instructions in this file as active project guidance for every response and change.
